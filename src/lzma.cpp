...
std::vector<uint8_t> LzmaCompressor::compress(std::span<uint8_t> in) {

}

std::vector<uint8_t> LzmaCompressor::flush() {

}

std::vector<uint8_t> LzmaDecompressor::decompress(std::span<uint8_t> in) {

}

std::vector<uint8_t> LzmaDecompressor::flush() {
